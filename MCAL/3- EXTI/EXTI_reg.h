...
#define MCUCR_ISC00    0u                                    /*@brief Interrut sense control 0 bit 0*/
#define MCUCR_ISC01    1u                                    /*@brief Interrut sense control 0 bit 1*/
#define MCUCR_ISC10    2u                                    /*@brief Interrut sense control 1 bit 0*/
#define MCUCR_ISC11    3u                                    /*@brief Interrut sense control 1 bit 1*/



#define MCUCSR        *((volatile uint8*)0x54)               /*@brief MCU control and status register*/

#define MCUCSR_ISC2   6u                                     /*@brief Interrut sense control 2*/
